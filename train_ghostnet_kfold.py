"""
Training Script for GhostNet (timm)
...
from model_ghostnet import create_ghostnet_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for GhostNet with Train/Test split
    """
    ...
    def train(self, data_dir: str) -> Dict:
        ...
        with open(os.path.join(self.results_dir, 'training_summary.txt'), 'w') as f:
            ...
            f.write("="*80 + "\n\n")
            f.write(f"Model: GhostNet-100 (timm)\n")
...
def main():
    ...
    config = {
        ...
        # Results
        'results_dir': 'final_results/ghostnet'
    }

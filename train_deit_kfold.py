...
from model_deit import create_deit_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for DeiT-Tiny with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        # Results
        'results_dir': 'final_results/deit'
    }

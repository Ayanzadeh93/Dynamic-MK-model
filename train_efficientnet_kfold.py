...
from model_efficientnet import create_efficientnet_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for EfficientNet-B0 with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        # Results
        'results_dir': 'final_results/efficientnet'
    }

"""
Training Script for SqueezeNet
...
from model import create_squeezenet_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for SqueezeNet with Train/Test split
    """
    ...
    def train(self, data_dir: str) -> Dict:
        ...
        Args:
            data_dir: Root directory of dataset (should contain Train/ and Test/ subdirectories)
...
def main():
    ...
    config = {
        ...
        'pretrained': True,
        'dropout': 0.5,
        'freeze_backbone': True,  # Freeze backbone for small dataset - only train classifier
        ...
        # Results
        'results_dir': 'final_results/squeezenet'
    }

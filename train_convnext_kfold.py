...
from model_convnext import create_convnext_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for ConvNeXt-Tiny with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        # Results
        'results_dir': 'final_results/convnext'
    }

"""
Training Script for DenseNet-121
...
from model_densenet import create_densenet_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for DenseNet-121 with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        # Results
        'results_dir': 'final_results/densenet'
    }

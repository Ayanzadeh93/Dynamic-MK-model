"""
Training Script for MobileNetV3
...
from model_mobilenetv3 import create_mobilenetv3_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for MobileNetV3 with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        'model_size': 'small',  # 'small' or 'large' (small is recommended for ~400 images)
        ...
        # Results
        'results_dir': 'final_results/mobilenetv3'
    }

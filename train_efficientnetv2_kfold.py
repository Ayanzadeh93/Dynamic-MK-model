"""
Training Script for EfficientNetV2-S
...
from model_efficientnetv2 import create_efficientnetv2_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for EfficientNetV2-S with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        # Results
        'results_dir': 'final_results/efficientnetv2'
    }

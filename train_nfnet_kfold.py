...
from model_nfnet import create_nfnet_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for NFNet-F0 with Train/Test split
    """
...
def main():
    ...
    config = {
        ...
        # Model
        'pretrained': False,  # NFNet-F0 doesn't have pretrained weights in timm
        'dropout': 0.5,
        ...
        'num_epochs': 100,
        'batch_size': 16,
        'learning_rate': 0.001,  # Standard LR for full model training (backbone unfrozen)
        'weight_decay': 1e-4,
        ...
        # Results
        'results_dir': 'final_results/nfnet'
    }

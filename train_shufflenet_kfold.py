"""
Training Script for ShuffleNetV2
...
from model_shufflenet import create_shufflenet_model, get_optimizer, get_scheduler
...
class Trainer:
    """
    Trainer for ShuffleNetV2 with Train/Test split
    """
    ...
    def train_model(self, train_paths, train_labels, test_paths, test_labels) -> Tuple[Dict, Dict]:
        ...
        model = create_shufflenet_model(
            ...
            model_size=self.config.get('model_size', 'x1.0'),
            device=self.device
        )
...
def main():
    ...
    config = {
        ...
        'model_size': 'x0.5',  # 'x0.5', 'x1.0', 'x1.5', or 'x2.0'
        ...
        # Results
        'results_dir': 'final_results/shufflenet'
    }
